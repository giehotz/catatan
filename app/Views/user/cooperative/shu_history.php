...
<div class="space-y-8 max-w-6xl mx-auto mt-4">
    ...
    <!-- Title Header -->
    <div class="space-y-1">
        <h1 class="text-3xl font-extrabold text-tx-primary tracking-tight">Riwayat Penerimaan SHU</h1>
        <p class="text-tx-secondary text-sm">Lihat pembagian Sisa Hasil Usaha (SHU) tahunan yang Anda terima dari Koperasi. SHU langsung dimasukkan ke saldo Simpanan Sukarela Anda.</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div class="bg-surface/40 border border-br-default rounded-2xl p-6 shadow-xl relative overflow-hidden flex flex-col justify-between h-32">
            ...
            <div class="flex items-baseline gap-2">
                <span class="text-2xl font-black text-tx-primary font-mono"><?= count($myShu) ?> Kali</span>
            </div>
        </div>
        ...
        <div class="bg-surface/40 border border-br-default rounded-2xl p-6 shadow-xl relative overflow-hidden flex flex-col justify-between h-32">
            ...
            <span class="text-xs text-tx-secondary leading-relaxed font-semibold">Tiap SHU yang dibagikan otomatis dimasukkan ke saldo <strong class="text-indigo-400">Simpanan Sukarela</strong> Anda dan dapat ditarik sewaktu-waktu.</span>
        </div>
    </div>
    ...
    <div class="bg-surface/40 border border-br-default rounded-2xl shadow-xl overflow-hidden">
        <div class="p-6 border-b border-br-default/60 flex items-center justify-between">
            <h3 class="text-lg font-bold text-tx-primary tracking-tight">Rincian Pembagian SHU</h3>
        </div>

        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm text-slate-300">
                <thead class="bg-base/80 text-xs font-bold uppercase tracking-wider text-tx-secondary border-b border-br-default">
                    <tr>
                ...
                <tbody class="divide-y divide-br-default/50">
                    <?php if (count($myShu) === 0) : ?>
                        <tr>
                            <td colspan="5" class="px-6 py-8 text-center text-tx-disabled font-semibold">Belum ada catatan penerimaan SHU untuk Anda.</td>
                        </tr>
                    <?php else : ?>
